...
public static class HelperMethods
{
    ...
    public static T[] GetComponentsAtBoxLocationNonAlloc<T>(int number, Vector2 point, Vector2 size, float angle)
    {
        //查找与box接触或位于盒体内部的所有碰撞体，并将它们存储到collider2DArray中
        Collider2D[] collider2DArray = new Collider2D[number];
